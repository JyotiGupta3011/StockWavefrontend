      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <br />
            <Link to="/product">Zerodha.tech</Link>
            <br />
            <Link to="/about">Press & media</Link>
            <br />
            <Link to="/about">Zerodha cares (CSR)</Link>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
          ...
          <div className="col">
            ...
            <br />
            <Link to="/support">Fund transfer</Link>
            <br />
